...
urls = [
    "https://sw.jnu.ac.kr/sw/8250/subview.do?enc=%3D%3D"
]
...
# HTMLHeaderSplitter를 통해 HTML Load와 Split 동시에 진행
html_splitter = HTMLHeaderTextSplitter(headers_to_split_on=headers_to_split_on)

html_header_splits = []
for url in urls:
    html_header_splits.extend(html_splitter.split_text_from_url(url))

# print(html_header_splits)
data = csv_data + html_header_splits
...
# 템플릿 객체 생성
template = """당신은 전남대학교의 정보에 대해서 알려주는 어시스턴트입니다.
